    ...
    <div class="v-list" v-loading="loading" element-loading-text="加载中">
        <el-card class="box-card">
            ...
            <el-table border :data="list" @sort-change="sortChange" style="width: 100%" highlight-current-row>
                ...
                <el-table-column prop="fenleimingcheng" label="分类名称" width="130">
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/xinwenfenleiupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.xinwenfenlei.list, filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm("确定删除数据？", "提示", {
                    ...
                    .then(() => {
                        ...
                        this.$post(api.xinwenfenlei.delete, {
                            // 提交后台
                            id: row.id,
                        })
                            .then((res) => {
