        ...
        <el-card class="box-card">
                ...
                <el-form @submit.prevent.stop :inline="true" size="mini">
                    ...
                    <el-form-item label="分类">
                        <el-select v-model="search.fenlei"
                            ...
                            ><e-select-option type="option" module="xinwenfenlei" value="id" label="fenleimingcheng"></e-select-option
                        ></el-select>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table border :data="list" @sort-change="sortChange" style="width: 100%" highlight-current-row>
                ...
                <el-table-column prop="fenlei" label="分类" width="80">
                    <template slot-scope="{row}"> <e-select-view module="xinwenfenlei" :value="row.fenlei" select="id" show="fenleimingcheng"></e-select-view> </template>
                </el-table-column>
                ...
                <el-table-column sortable="custom" prop="dianjilv" label="点击率" width="80">
                    <template slot-scope="{row}"> {{ row.dianjilv }} </template>
                </el-table-column>
                <el-table-column prop="tianjiaren" label="添加人" width="80">
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit" @click="$goto({path:'/admin/xinwenxinxiupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.xinwenxinxi.list, filter)
                    .then((res) => {
                        this.loading = false;
            ...
            deleteItem(row) {
                this.$confirm("确定删除数据？", "提示", {
                    ...
                    .then(() => {
                        ...
                        this.$post(api.xinwenxinxi.delete, {
                            // 提交后台
                            id: row.id,
                        })
                            .then((res) => {
