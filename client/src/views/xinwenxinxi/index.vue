    ...
    <div v-loading="loading">
        <div style="margin: 20px 0 0 0">
            <e-container>
                ...
                <div class="">
                    <e-news-list v-for="r in list" :key="r.id" :to="'/xinwenxinxidetail?id='+r.id" :title="r.biaoti" :description="r.neirong" :len="30" :image="r.tupian">
                ...
                <div style="margin-top: 10px; text-align: center">
                    <el-pagination @current-change="loadList" :current-page="page" :page-size="15" layout="total, sizes, prev, pager, next, jumper" :total="totalCount">
                    </el-pagination>
                </div>
            </e-container>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.xinwenxinxi.weblist, filter)
                    .then((res) => {
                        this.loading = false;
