        ...
        <div class="admin_login_wrap" v-loading="loading">
            ...
            <div class="adming_login_border">
                ...
                <div class="admin_input">
                    <form action="javascript:;" method="post">
                        <ul class="admin_items">
                            ...
                            <div class="button-login" style="float: none;text-align: center">
                                <el-button type="primary" @click="dialogVisible=true" style="width: 100%">用户注册</el-button>
                            </div>
                        </ul>
                    </form>
                    <el-dialog
                    ...
                    >
                        <yonghu-add @success="dialogVisible=false"></yonghu-add>
                    </el-dialog>
...
<script>
    ...
    import api from "@/api";
    import YonghuAdd from "@/views/yonghu/add";
    export default {
        name: "login-index",
        components: {YonghuAdd},
        data() {
            return {
                setting,
                captchUrl: null,
