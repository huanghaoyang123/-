        ...
        <el-card class="box-card">
            ...
            <div class="form-database-form">
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    >
                        <el-input type="text" disabled   placeholder="输入用户名" style="width: 250px" v-model="form.yonghuming" />
                    </el-form-item>

                    <el-form-item label="姓名" prop="xingming" required :rules="[{required:true, message:'请填写姓名'}]">
                        <el-input type="text" disabled   placeholder="输入姓名" style="width: 250px" v-model="form.xingming" />
                    </el-form-item>
