                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="回复" placement="top">
                                <el-button
                                        v-if="row.zhuangtai == '待回复'" icon="el-icon-edit" @click="$goto({path:'/admin/yiqingshangbaoupdt',query:{id:row.id } })" type="warning" size="mini"></el-button>
                            </el-tooltip>
    ...
    export default {
        ...
        methods: {
            ...
            loadList(page) {
                ...
                this.$post(api.yiqingshangbao.list, filter)
                    .then((res) => {
                        this.loading = false;
