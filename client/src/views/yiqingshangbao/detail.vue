<template>
    <div class="yiqingshangbao-detail" v-loading="loading" ref="print">
        ...
        <div class="admin-detail">
            ...
            <div class="detail detail-textarea">
                <div class="detail-title">上报内容：</div>
                <div class="detail-content">{{ map.shangbaoneirong }}</div>
            </div>
            <div class="detail detail-textarea">
            ...
            <div class="detail detail-textuser">
                <div class="detail-title">上报用户：</div>
                <div class="detail-content">{{ map.shangbaoyonghu }}</div>
            </div>
            ...
            <div class="detail detail-autotime">
                <div class="detail-title">上报时间：</div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDetail() {
                ...
                this.loading = true;
                this.$get(api.yiqingshangbao.detail, {
                    id: this.id,
                })
                    .then((res) => {
                        this.loading = false;
