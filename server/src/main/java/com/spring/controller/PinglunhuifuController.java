...
public class PinglunhuifuController extends BaseController {
    ...
    public String list() {
        ...
        Example example = new Example(Pinglunhuifu.class); //  创建一个扩展搜索类
        ...
        List<Pinglunhuifu> list = service.selectPageExample(example, page, pagesize); // 获取当前页的行数
    ...
    public String listpinglunren() {
        ...
        List<Pinglunhuifu> list = service.selectPageExample(example, page, pagesize);
        assign("totalCount", request.getAttribute("totalCount"));
        assign("list", list);
    ...
    @RequestMapping("/pinglunhuifu_add")
    public String add() {
        _var = new LinkedHashMap(); // 重置数据
