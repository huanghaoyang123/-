...
public class YouqinglianjieController extends BaseController {
    ...
    public String update() {
        ...
        // 将前台表单数据填充到实体类
        if (!Request.get("wangzhanmingcheng").equals("")) post.setWangzhanmingcheng(Request.get("wangzhanmingcheng"));
        if (!Request.get("wangzhi").equals("")) post.setWangzhi(Request.get("wangzhi"));
    ...
    public String delete() {
        ...
        Map map = Query.make("youqinglianjie").find(id);
